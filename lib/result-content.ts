...
export const resultContents: Record<ResultTypeId, ResultContent> = {
  "combined-barrier": {
    ...
    action48h: ["写出一句内容：", "“我不是最懂____的人，但我可能是最懂____场景里，如何帮____做到____的人。”"],
  ...
  "scene-focus": {
    ...
    action48h: ["补全这句话：", "“我最懂____这类人，在____场景里遇到的____问题。”"],
  ...
  "relationship-start": {
    ...
    action48h: ["给3个人发消息：", "“我最近在做一个____方向的小产品/服务，想请你帮我看一下，你觉得这个方向像不像我？”"],
  ...
  "minimum-combination": {
    ...
    action48h: ["写下你的最小组合：一个小场景：____；一个新能力：____；一个公开作品：____。"],
